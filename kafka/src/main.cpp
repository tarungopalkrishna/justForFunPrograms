...
class Consumer {
   private:
    ...
    // This is the queue for data consumed
    std::queue<RdKafka::Message> data_queue;
   ...
   public:
     ...
     *
     * Creates a consumer object with the preset config.
     *
     * @bug Will need to subscribe to topic in this function and not in a separate function.
     *
     * @return true
     * @return false
     */
    ...
    /**
     * @brief Connect to a kafka topic(s).
     *
    ...
    void consume() {
        while (run) {
            // consume takes timeout as argument
            RdKafka::Message *msg = consumer->consume(1000);
            msg_consume(msg, NULL);
            // Add this message to the queue.
            this->data_queue.push(msg);
            delete msg;
        }
    }
